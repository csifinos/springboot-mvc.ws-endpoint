...
import com.github.csifinos.wsendpoint.websocket.InstanceIdentity;
...
public class PresenceService {
    ...
    public void register(String sessionId, String simpSessionId) {
        ...
        Presence record = new Presence(simpSessionId, sessionId, instanceIdentity.getInstanceId(), ttlSeconds);
